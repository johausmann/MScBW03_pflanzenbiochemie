...
* State transitions
  ...
  * PSII-Überanregung (State 2)
    ...
    + Stn7-Kinase phosphoryliert LHCII und __wandert an PSI__
    &rarr; PSI mehr Energie durch relativ größere Lichtantenne
...
* Nachweise der State Transitions
  ...
  * Western Blot Analyse
  ...
  + Messung der Fluoreszenzemission als Maß für die Energieverteilung
      + Charakteristissche Peaks der PS und LHCs &rarr; Unterschiedung der Photosysteme möglich
...
* Angepasstes Modell
  ...
  * Statetransition 1 &rarr; 2
      + Phosphorylierung des LHCII im Pool von PSII
      + Loosely bound werden von PSII entfernt
      + Bindung an PSI nach Phosphorylierung (aus Pool des PSI)
  * Statetransition 2 &rarr; 1
      + Dephosphorylierung &rarr;vize versa
  
  * Freies LHCII muss gequencht werden
      + Würde sonst Floureszieren und die Antennengröße nicht geändert (Reabsorption benachbarte Pigmente)
...
* NPQ
  ...
  * Zeaxanthin, Violaxanthin in LHCII und inneren Antennen des PSII sowie PSI
