...
* Diatomeen betreiben CO2 fixierung
  *  besitzen gene für Carbonahydrase &rarr; CO2 (Gas) zu HCO3- (wasserlösl.) und umgekehrt
  * Enzyme für C4 Stoffwechsel vorhanden &rarr; vorfixierung Kohlenstoff
  * für Pflanzen an trockenen Orten &rarr; Vermeidung von Wasserverlust
  * bei Diatomeen kommt es aber nie zu HCO3- Knappheit
  
* Regulation Calvin Zyklus
  * nicht mittels Thioredoxin reguliert wie bei höheren Pflanzen
  * Calvin- und oxidativer Pentosephosphatweg unterschiedlich lokalisiert &rarr; gegeneinander Regulierung möglich, da ox. Pentosephosphatweg sich im Cytosol befindet
  
* Speicherassimilate
  * Diatomeen verwenden Chrysolaminarin statt Stärke wie höhere Pflanzen
  * Chrysolaminin wasserlöslich &rarr; in Vakuole gespeichert
...
* Glykolyse
  ...
  * Problem: stört den Calvin Zyklus &rarr; Regulation benötigt
  
## Molecular Tools für Diatomeen

### Biolistisch
* Starke Selektion, da nur wenige Zellen überleben
* Vektoren können leicht brechen
  
### Elektroporation
* Variable Ergebnisse &rarr; funktioniert nicht bei allen
...
* Protein, welches an gewünschter Stelle schneidet
* Induziiert Doppelstrangbrüche, welche mittels NHEJ repariert werden (fehleranfällig)
* Eingefügte Indels führen zu Knock-Outs
* TALE Sequenz muss so konzipiert werden, dass an gewünschter Stelle geschnitten wird

## CRISPR-Cas9

* gRNA definiert Ziel der Schnittstelle
* induziiert Doppelstrangbrüche
* Reparatur mittels NHEJ
* Bei insertions/deletions > 3 Basen &rarr; Knock-Out
...
* Diplonten aber keine Kreuzung möglich bzw. sehr schwer
...
* Diatomeen besitzen von natur aus viel ungesättigte Fette &rarr; wichtig für Ernährung
