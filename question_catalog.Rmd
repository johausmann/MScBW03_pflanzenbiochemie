...
* Nachweise der State Transitions
  ...
  * Blue-native PAGE &rarr; Auftrennung PSI-LHCI -LHCII Komplexe
...
* PSI-LHCI-LHCII Komplex
  ...
  * LHCII aus 3 Proteinen aufgebaut (Lhcb{1,2,3})
    ...
    + PSI-LHCII weißt Kombination aus Lhcb1 und 2 auf &rarr; LHCII Trimer-S (strongly)
...
* NPQ beruht nicht auf einer einzigen molekularen Ursache  
  &rarr; Lichtintensit und pH lösen verschiedene Reaktionen aus  
  + Geschieht auf Level der minoren Antennen zusammen mit LHCII
...
* Diversität in der Thylakoidstruktur
  ...
  + Grana/Stromathylakoide - Spermatophyta (streng genommen nur in höhren Pflanzen, aber auch Grünalgen)
...
* Chloroplasten mit 3-4 Hüllmebranen
  ...
  + PPC (periplastidische Kompartement) &rarr; Symbionten Cytosol mit Nukleomorph (falls vorhanden)
